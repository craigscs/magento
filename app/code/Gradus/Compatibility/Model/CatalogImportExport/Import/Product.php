...
namespace Gradus\Compatibility\Model\CatalogImportExport\Import;
...
class Product extends \Magento\CatalogImportExport\Model\Import\Product
{
    ...
    protected $_linkNameToId = [
        ...
        '_compatibility_' => \Gradus\Compatibility\Model\Catalog\Product\Link::LINK_TYPE_COMPATIBILITY
    ];
    ...
    protected $_fieldsMap = [
        ...
        '_compatibility_sku' => 'compatibility_skus',
        '_compatibility_position' => 'compatibility_position',
    ];
