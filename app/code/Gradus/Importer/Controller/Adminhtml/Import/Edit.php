...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Magento_Backend::system_convert')
            ->addBreadcrumb(__('Imports'), __('Imports'))
            ->addBreadcrumb(__('Manage Imports'), __('Manage Imports'));
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('import', $model);
        ...
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? $model->getTitle() : __('New Import'));
